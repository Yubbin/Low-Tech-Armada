...
public class ReclaimedMineStrikeStats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
	
	public static float MINE_RANGE = 2500f; //originally 1500f
	
	public static final float MIN_SPAWN_DIST = 400f; //originally 75f
	
	public static final float LIVE_TIME = 40f; //originally 5f
	
	public static final Color JITTER_COLOR = new Color(204,41,0,75);
	public static final Color JITTER_UNDER_COLOR = new Color(204,41,0,155);
